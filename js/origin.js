(function () {
    ...
    function buildSceneMarkup(container) {
        ...
        container.innerHTML = [
            ...
            '      <img class="origin-base" id="origin-base-image" src="data/imgs/art_design/origin.png" alt="殿墙与隔扇门整体">',
            '      <button type="button" class="origin-layer" data-layer="o1" aria-label="聚焦殿墙中的木构开间"><img src="data/imgs/art_design/o1.png" alt=""></button>',
            '      <button type="button" class="origin-layer" data-layer="o2" aria-label="聚焦隔扇门扇"><img src="data/imgs/art_design/o2.png" alt=""></button>',
            '      <button type="button" class="origin-layer" data-layer="o3" aria-label="聚焦格心窗棂"><img src="data/imgs/art_design/o3.png" alt=""></button>',
            '      <button type="button" class="origin-layer" data-layer="o4" aria-label="聚焦绦环板"><img src="data/imgs/art_design/o4.png" alt=""></button>',
            '      <button type="button" class="origin-layer" data-layer="o5" aria-label="聚焦裙板"><img src="data/imgs/art_design/o5.png" alt=""></button>',
            "    </div>",
            "  </div>",
